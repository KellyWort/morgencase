...
2. Click the **Add Block** button, select the **Patterns** tab, click the **Cover and Overlapped Featured Services** pattern.
3. Edit the pattern's text/images to really make it your own.
